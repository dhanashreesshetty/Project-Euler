...
class javaprog
{
	...
	{
		int digits, sum, limit=1000000, temp, i=0;
		char number[]=new char[10];//this will hold the millionth permutation
		int fact[]={0,1,2,6,24,120,720,5040,40320,362880};
		boolean chosen[]={false,false,false,false,false,false,false,false,false,false};//this list will tell us whether a digit has already been included in the number
